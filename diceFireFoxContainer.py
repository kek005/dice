...
class Dice:
    def __init__(self):
            ...
            profile_path = r'/app/firefox_profile'
            ...
            self.thisrun = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
            self.alreadycompleted_job_file_path = f"/app/logs/dice_{self.thisrun}.log"
            self.completed_job_file_path = f"/app/logs/dice_{self.thisrun}.log"
            self.incompleted_job_file_path = f"/app/logs/dice_{self.thisrun}.log"
    ...
    def log_incomplete_job(self, job_title, job_company):
        ...
        with open(self.incompleted_job_file_path, "a") as log_file:
    ...
    def log_completed_job(self, job_title, job_company):
        ...
        with open(self.completed_job_file_path, "a") as log_file:
    ...
    def log_alreadycomplete_job(self, job_title, job_company):
        ...
        current_time = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        # Logic to log the job ID with timestamp for which application was successfully completed
        with open(self.alreadycompleted_job_file_path, "a") as log_file:
